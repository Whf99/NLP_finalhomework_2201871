...
def process_frame(img):
    ...
    if results.multi_hand_landmarks: # 如果有检测到手
        ...
        img = cv2.putText(img, 'FPS  '+str(int(FPS)), (25 * scaler, 50 * scaler), cv2.FONT_HERSHEY_SIMPLEX, 1 * scaler, (255, 0, 255), 2 * scaler)
    return img

def generate_video(input_path='/Users/apple/Desktop/NLP/test.mp4'):
...
generate_video(input_path='/Users/apple/Desktop/NLP/test.mp4')
